  ...
  componentDidMount() {
    ...
    if (this.props.route.params.status == "active") {
      ...
      if (this.props.route.params.data.type == "notification") {
        this.getPostDetailsAPI(
          this.props.route.params.data.notification_id,
          this.props.route.params.data.type
        );
      } else {
        this.getPostDetailsAPI(
          this.props.route.params.data.post_id,
          this.props.route.params.data.type
        );
      }
    }
      ...
      <ScrollView>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          >
            ...
            >
              {this.props.route.params.data.no_of_bales}
            </Text>
          </View>
          ...
          >
            ...
            >
              {this.props.route.params.type == "notification"
                ? "Notification"
                : "Post"}
            </Text>
          </View>
          ...
          <View style={{ flexDirection: "row", width: "100%" }}>
            ...
            >
              ...
              {this.props.route.params.status == "completed" ? (
                <Text
                  numberOfLines={1}
                  ellipsizeMode="tail"
                  style={{
                ...
                >
                  {this.props.route.params.data.created_at}
                </Text>
              ) : (
                <Text
                  numberOfLines={1}
            ...
            >
              {this.props.route.params.status != "active" ? (
                <Text
                  numberOfLines={1}
                  ellipsizeMode="tail"
                  style={{
                ...
                >
                  {this.props.route.params.status == "complete"
                    ? "Deal Done at"
                    : "Cancel at"}
                </Text>
              ) : null}
              ...
              {this.props.route.params.status == "complete" ? (
                ...
                >
                  {this.props.route.params.data.updated_at}
                </Text>
              ) : (
                <Text
                  numberOfLines={1}
          ...
          {this.props.route.params.data.type == "notification"
            ? this.createNotificationListUI(
                this.props.route.params.data.seller_array
              )
            : null}
        </View>
      </ScrollView>
